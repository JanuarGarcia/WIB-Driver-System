  ...
  return (
    <header className="main-header">
      ...
      <div className="main-header-actions">
        {onOpenNewTask ? (
          <button type="button" className="btn-add-task" onClick={onOpenNewTask}>Add New Task</button>
        ) : (
          <Link to="/new-task" className="btn-add-task">Add New Task</Link>
        )}
        <button type="button" className="main-header-icon" aria-label={soundMuted ? 'Unmute sound' : 'Mute sound'} aria-pressed={soundMuted} onClick={toggleSound} title={soundMuted ? 'Unmute' : 'Mute'}>
        ...
        <div className="main-header-notif-wrap" ref={notifRef}>
          <button type="button" className="main-header-icon" aria-label="Notifications" aria-expanded={notificationsOpen} onClick={() => setNotificationsOpen((o) => !o)}>
            <span className="main-header-icon-inner">
        ...
        <div className="main-header-lang-wrap">
          <label htmlFor="main-header-lang" className="main-header-lang-label">Language</label>
          <select
            id="main-header-lang"
            className="main-header-lang-select form-control"
            value={language}
        ...
        <Link to="/settings" className="main-header-icon" aria-label="Settings">
          <span className="main-header-icon-inner">
