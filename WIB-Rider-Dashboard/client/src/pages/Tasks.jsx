                ...
                <tr key={t.task_id}>
                  ...
                  <td className="tasks-actions-cell">
                    <div className="table-actions">
                      <button type="button" className="btn btn-sm btn-outline-view" onClick={() => openDetails(t.task_id, t)} title="View details">
                        View
                      </button>
                      {(() => {
                        ...
                        return (
                          <button type="button" className="btn btn-primary btn-sm" onClick={() => setAssignTaskId(t.task_id)}>
